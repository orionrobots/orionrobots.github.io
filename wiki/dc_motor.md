...
---
This is basically a "Common or garden" <a href="/wiki/motor.html" title="Motor">motor</a>.  It might be referred to as a "Fixed Magnet DC Motor" as there are other motors which run on DC - this is just what is commonly meant when people simply say a motor or DC motor.

It is operated by a <a href="/wiki/direct_current.html" title="Direct Current">Direct Current</a> and rotates in a direction set by the polarity of the current.
...
* DC Motors draw a lot of current, especially when starting up - this may actually drain it from the control circuitry, and starve it. It is therefore recommended you have a seperate power supply for these, and use a H-Bridge or <a href="/wiki/electronic_relay.html" title="An electrically activated switch">Electronic Relay</a> to control them.
