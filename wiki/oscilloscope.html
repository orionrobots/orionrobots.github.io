...
<p>Analog<a class="wiki wikinew for-review" title="Create page: Analog">?</a> oscilloscopes are the classic type. They are fairly bulky and heavy because they are based on a monochrome CRT tube with one input tied to each of the coils. Other than the preamps<a class="wiki wikinew for-review" title="Create page: preamps">?</a> and the horizontal signal generation, they tend to be fairly low on additional features.
</p>
<p>They do not suffer the quantization that all digital scopes may do, and this may mean that you can take very precise measurements. These were very expensive - as CRT based equipment normally was, and if you wish to acquire one, it is best done through ebay<a class="wiki wikinew for-review" title="Create page: ebay">?</a>.
</p>
...
</li><li> eBay<a class="wiki wikinew for-review" title="Create page: eBay">?</a> may have any of them, just make sure you check out the seller and see what chance you have of it working when you get it. Try and at least get a guarantee that it will not be DOA.
</li><li> FreeMesa<a class="wiki wikinew for-review" title="Create page: FreeMesa">?</a> - You may find a free scope locally on freemesa, or be able to place a wanted ad.
...
</li><li> Freecycle<a class="wiki wikinew for-review" title="Create page: Freecycle">?</a> - Freecycle is similar, but harder to use than freemesa.
</li></ul><p>
