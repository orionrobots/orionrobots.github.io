...
<p>This method works well in with <a class="wiki" href="/wiki/rodney_brooks.html" title="Rodney Brooks">Rodney Brooks</a> subsumption architecture<a class="wiki wikinew for-review" title="Create page: subsumption architecture">?</a>, as once you have subdivided all but the most menial tasks, then an <a class="wiki" href="/wiki/ai.html" title="Artificial Intelligence">AI</a> comparable to a computer game AI may be good enough to control the robot.
</p>
