...
---
<p>Pocket PC's are a <a class="wiki" href="/wiki/personal_data_assistant.html" title="Personal Data Assistant">Personal Data Assistant</a> group which use Windows CE operating system.
</p>
<p>Some models may be re-flashed with a Linux operating system, making them more usable in robotics applications.
</p>
<p>They have a minimum of an LCD touch screen, <a class="wiki" href="/wiki/infra_red.html" title="A type of EM radiation commonly used for digital communications">Infra Red</a>, <a class="wiki" href="/wiki/wifi.html" title="Wireless Lan">WiFi</a> and/or  BlueTooth communication port and some kind of USB or <a class="wiki" href="/wiki/serial_data_stream.html" title="Serial Data Stream">Serial Data Stream</a> connector.
</p>
<p>Their small size and low power consumption may make them interesting robot control devices, while the touch screen gives a good method of Human Computer Interaction<a class="wiki wikinew for-review" title="Create page: Human Computer Interaction">?</a> with a robot.
</p>
<p>Orion used to own the HP1910 colour device which at present cannot be flashed with another operating system. He now owns the Dell Axim x30, for which other OS's are being ported.
</p>
<p>If you buy one, you should ensure it has SDIO or CF slot, and take note of BlueTooth or WiFi systems it may come with.  If you are going to use it for robot applications - then consider the weight and power consumption.
</p>
<p>If you are going to attempt to use it for remote control of robots - check if it supports consumer IR (all-in-one remote control ability).
</p>
<p>Communicating with RCX from a PocketPC with Infra Red<a class="wiki wikinew for-review" title="Create page: Communicating with RCX from a PocketPC with Infra Red">?</a>
</p>
<p>Communicating with Cybot from a PocketPC with Infra Red<a class="wiki wikinew for-review" title="Create page: Communicating with Cybot from a PocketPC with Infra Red">?</a>
</p>
<p>Bibliography
</p>
