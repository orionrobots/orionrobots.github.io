...
tags: [robot building, tools, electronics]
---
{% include JB/setup %}
...
You can cable tie wires in bunches. However, this may mean needing to clip the cable ties back off if you want to make changes. It can still bunch though.
