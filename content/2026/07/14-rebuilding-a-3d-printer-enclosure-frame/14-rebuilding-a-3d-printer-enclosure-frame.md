...
{% img_responsive "unitak-enclosure-frame-damage.jpg", "The Unitak 3D printer enclosure, sat on a shelf next to a row of robotics books" %}

{% img_responsive "broken-corner-joint-closeup.jpg", "Closeup of a snapped plastic corner joint with a fibreglass rod" %}
...
{% img_responsive "aluminium-extrusion.png", "Aluminium Extrusions" %}
