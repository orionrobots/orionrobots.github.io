...
![Bridge Rectifier schematic]({{gallery}}/609-bridge-schematic.png){..img-fluid .mx-auto .d-block}
...
![My workshop for building the freeform rectifier]({{gallery}}/258-workshop.jpg){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/261-diodes-on-a-tape.jpg){.img-fluid .img-rounded .mx-auto .d-block .col-sm-6} ![]({{gallery}}/262-diodes-2.jpg){.img-fluid .mx-auto .d-block .col-sm-6}
![]({{gallery}}/263-diodes-2-sets.jpg){.img-fluid .mx-auto .d-block .col-sm-6}
![]({{gallery}}/264-tape-removed.jpg){.img-fluid .mx-auto .d-block .col-sm-6}
...
![Povray rendered diode bridge freeforms]({{gallery}}/157-bridgefreeforms4.png){..img-fluid .mx-auto .d-block}

## Step 1 First Bend

![]({{gallery}}/610-freeform-bridge-step-1.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/265-step1-ready-to-solder.jpg){..img-fluid .mx-auto .d-block}

## Step 2 Solder the legs

![]({{gallery}}/611-freeform-bridge-step-2.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/266-step-2-first-set-soldered.jpg){..img-fluid .mx-auto .d-block}

## Step 3 Trim one leg

![]({{gallery}}/612-freeform-bridge-step-3.png){..img-fluid .mx-auto .d-block}

Cut off the excess going out to the side.
Trim as close to the solder joint as you can, but don't snip the joint.

![]({{gallery}}/267-step-2-first-set-soldered.jpg){..img-fluid .mx-auto .d-block}

## Step 4 - repeat for an opposite pair

The pair should look like this.

![]({{gallery}}/613-freeform-bridge-step-4.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/268-step-4-second-set-soldered.jpg){..img-fluid .mx-auto .d-block .col-sm-6}
![]({{gallery}}/269-step-4-second-set-soldered-2.jpg){..img-fluid .mx-auto .d-block .col-sm-6}

## Step 5 - Bend one set of legs upwards

![]({{gallery}}/614-freeform-bridge-step-5.png){..img-fluid .mx-auto .d-block}

On only ONE set of diodes, bend the legs upward at the red crosses.

![]({{gallery}}/270-step-5-legs-bent-upwards.jpg){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/272-legs-trimmed.jpg){..img-fluid .mx-auto .d-block .col-sm-6}
![]({{gallery}}/273-legs-trimmed.jpg){..img-fluid .mx-auto .d-block .col-sm-6}

## Step 6- Bring the two pairs together

![]({{gallery}}/615-freeform-bridge-step-6.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/274-bring-sets-together.jpg){..img-fluid .mx-auto .d-block}

## Step 7 - Solder the lower legs to the upper ones

![]({{gallery}}/616-freeform-bridge-step-7.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/617-freeform-bridge-complete.png){..img-fluid .mx-auto .d-block}
...
![]({{gallery}}/275-two-sets-soldered.jpg){..img-fluid .mx-auto .d-block}

## Testing the diode bridge

![]({{gallery}}/309-full-test-rig.jpg){..img-fluid .mx-auto .d-block}
Here you get a good view of the full rig, including one of the better shots of the signal generator (in the transparent box).{..mx-auto .d-block}
...
![]({{gallery}}/315-full-wave.jpg){..img-fluid .mx-auto .d-block}
This is my oscilloscope showing the full wave generated by my signal generator - its quite clean.

![]({{gallery}}/314-clear-result.jpg){..img-fluid .mx-auto .d-block}
