...
![Circle divided with angles]({{ gallery }}/cutting_the_circle.png){.class="img-fluid"}
...
![A square in a circle]({{ gallery }}/square.png){.class="img-fluid"}
...
![A triangle in a circle]({{ gallery }}/triangle.png){.class="img-fluid"}
...
![Pentagons and Hexagons]({{ gallery }}/pentagon_and_hexagon.png){.class="img-fluid"}
...
[The full sheet]({{ gallery }}/whole_page.png){.class="img-fluid"}
