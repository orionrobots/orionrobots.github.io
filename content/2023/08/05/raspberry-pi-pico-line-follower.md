...
thumbnail: /content/2023/08/05/line-follower-thumbnail.png
...
2. **Stand-Off Kit**: Use a stand-off kit to position the line follower below the robot. The Maker Line has slots that accommodate various bolting hole placements, offering flexibility in mounting. You can either drill holes in the robot's chassis or use existing holes if it's predrilled.
    ...
    {% img_responsive "content/2023/08/05/maker-line-side-attachment.png", "Attaching the line follower" %}
...
{% img_responsive "content/2023/08/05/Cytron Maker Line Wiring.png", "Cytron Maker Line Wiring" %}
...
{% img_responsive "content/2023/08/05/line-sensor-algorithm-editable.png", "Two worked example scenarios for the line following algorithm." %}
